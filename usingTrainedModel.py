...
model_filename = 'waterpotability_voting_model.pkl'
voting_model = joblib.load(model_filename)
...
user_prediction = voting_model.predict(user_scaled)
